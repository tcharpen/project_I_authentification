...
describe 'server_authentication' do
  ...
  describe 'registration' do
    ...
    context 'An user (register or unregister) send POST to /register' do
    ...
    context 'An unregistered user send POST to /register' do
      context 'with a password, with a login' do
    ...
    context 'A register client send a post /registered' do
      context 'with a password, with a login' do
        it 'should redirect to /register' do
